"""
FTP server constants for GNSS product resources.

These are the primary FTP servers used for downloading GNSS PPP products.
"""
...
KASI_FTP = "ftp://nfs.kasi.re.kr"

# European Space Agency GSSC
ESA_FTP = "ftp://gssc.esa.int"

# NASA CDDIS (Crustal Dynamics Data Information System)
CDDIS_FTP = "ftp://gdc.cddis.eosdis.nasa.gov"
