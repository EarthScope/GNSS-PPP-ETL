...
RemoteSearchPlanner — registry of remote data centers and their resolved catalogs.
"""
...
class RemoteSearchPlanner:
    ...
    Usage::
        ...
        remote = RemoteSearchPlanner(product_catalog)
    ...
    def all_queries(self) -> List[SearchTarget]:
        """Flattened list of every search target across all registered centers."""
