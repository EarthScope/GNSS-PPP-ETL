...
# Import directly: from gnss_ppp_products.specifications.format.format_spec import FormatCatalog

# FormatRegistry lives in format_catalog.py (read-only registry of raw format specs)
# Import directly: from gnss_ppp_products.specifications.format.format_catalog import FormatRegistry
