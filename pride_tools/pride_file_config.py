...
class SatelliteProducts(BaseModel):
    ...
    satellite_orbit: Optional[str] = Field(
        default="Default", pattern=r".*\.SP3", description="File name of SP3 file"
    )
    satellite_clock: Optional[str] = Field(
        default="Default", pattern=r".*\.CLK", description="File name of CLK file"
    )
    erp: Optional[str] = Field(
        default="Default", pattern=r".*\.ERP", description="File name of ERP file"
    )
