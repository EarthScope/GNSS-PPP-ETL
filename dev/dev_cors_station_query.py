...
date = datetime.datetime(2026, 1, 3, tzinfo=datetime.timezone.utc)
...
for network in networks:
    for version in versions:
        sq = base_query.networks(network).rinex_version(version)
...
target_dir = Path("/Volumes/DunbarSSD/Project/SeafloorGeodesy/GNSS-PPP/2026/003/rinex")
